  ...
  const services = [
    {
      ...
      description:
        "Dominate Google search results and drive qualified traffic to your website",
      features: [
        "Keyword Research",
    ...
    },
    {
      ...
      description:
        "Targeted advertising campaigns that generate immediate results and ROI",
      features: [
        "Campaign Setup",
        "Keyword Targeting",
        "Ad Copy Creation",
    ...
    },
    {
      ...
      description:
        "Build your brand and engage with customers across all social platforms",
      features: [
        "Content Creation",
  ...
  const process = [
    {
      ...
      description:
        "We analyze your market, competitors, and target audience to create a winning marketing strategy.",
    },
    {
      step: "02",
      title: "Campaign Setup",
      description:
        "We set up and optimize your marketing campaigns across all relevant platforms.",
    },
    {
      step: "03",
      title: "Content Creation",
      description:
        "We create compelling content that resonates with your audience and drives engagement.",
    },
    {
      step: "04",
      title: "Monitor & Optimize",
      description:
        "We continuously monitor performance and optimize campaigns for maximum ROI.",
    },
  ];
        ...
        <div className="relative z-10 container mx-auto px-4 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg lg:text-xl text-gray-200 mb-8 max-w-3xl mx-auto leading-relaxed">
              Our data-driven marketing strategies help you reach the right
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Button
                size="lg"
                className="bg-red-600 text-white px-8 py-3 text-lg rounded-full shadow-lg static-element"
              >
                Get Your Free Audit
              ...
              <Button
                size="lg"
                variant="outline"
                className="border-2 border-white text-white px-8 py-3 text-lg rounded-full shadow-lg static-element"
              >
                View Case Studies
              </Button>
            </div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                ...
                campaigns deliver measurable results and drive business growth.
              </p>
            </div>
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-6xl mx-auto text-center text-white">
            ...
            <p className="text-xl mb-8 opacity-90 max-w-3xl mx-auto">
              These aren't just numbers. They're real results from real
              businesses that trusted us with their digital marketing.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                size="lg"
                className="bg-white text-red-600 px-6 py-3 text-base rounded-full static-element"
              >
                Start Your Campaign
                <ArrowRight className="ml-2 h-5 w-5" />
              </Button>
