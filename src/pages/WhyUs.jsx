...
import { CheckCircle, Star, Users, Award, Zap, Target, ArrowRight, Quote } from "lucide-react";
...
const WhyUs = () => {
  const benefits = [
    {
      ...
      description: "Every solution we create is designed to drive measurable business results and return on investment.",
      stats: "300% average ROI increase"
    },
    {
      icon: <Zap className="h-8 w-8 text-yellow-500" />,
      title: "Fast Delivery",
      description: "We understand time is money. Our streamlined processes ensure quick turnaround without compromising quality.",
      stats: "50% faster delivery"
    },
    {
      icon: <Users className="h-8 w-8 text-green-500" />,
      title: "Dedicated Support",
      description: "You're not just another client. We provide ongoing support and are here for you long after launch.",
      stats: "24/7 support available"
    },
    {
      icon: <Award className="h-8 w-8 text-purple-500" />,
      title: "Proven Expertise",
      description: "Years of experience combined with cutting-edge technology to deliver exceptional results.",
  ...
  const testimonials = [
    {
      ...
      role: "CEO",
      content: "DigitalMal transformed our online presence completely. Our website traffic increased by 400% and we're generating 3x more leads than before. Their attention to detail and ongoing support is outstanding.",
      rating: 5,
    ...
    },
    {
      ...
      role: "Founder",
      content: "The AI automation they set up for our marketing has been a game-changer. We're saving 20 hours per week and our conversion rates have doubled. Highly recommend their services!",
      rating: 5,
    ...
    },
    {
      ...
      content: "Working with DigitalMal was the best decision we made for our business. They understood our needs perfectly and delivered beyond our expectations. Our local SEO rankings improved dramatically.",
      rating: 5,
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Hero Section */}
      <section className="relative min-h-screen flex items-center bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-100 overflow-hidden">
        {/* Background Pattern */}
                ...
                <Card key={index} className="p-8 hover:shadow-xl transition-all duration-300 border-0 shadow-lg">
                  <CardHeader className="pb-4">
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        <CardTitle className="text-2xl text-gray-900 mb-2">{benefit.title}</CardTitle>
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                We follow a systematic approach that ensures your project is delivered 
