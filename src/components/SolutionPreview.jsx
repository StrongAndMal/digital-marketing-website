...
export const SolutionPreview = () => {
  const solutions = [
    ...
    },
    {
      ...
      description:
        "Dominate Google search results and drive qualified traffic to your business",
      features: [
        "Local SEO",
        "Keyword Research",
        "Content Strategy",
    ...
    },
    {
      ...
      description:
        "Automated marketing campaigns that work 24/7 to grow your business",
      features: [
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We don't just build websites or run ads. We create complete
              digital ecosystems that generate leads, increase sales, and grow
              your business.
            </p>
          </div>
          ...
          <div className="bg-gradient-to-r from-purple-600 to-blue-600 rounded-2xl p-8 lg:p-12 text-white text-center">
            ...
            <p className="text-lg mb-8 opacity-90 max-w-2xl mx-auto">
              ...
              businesses that trusted us with their digital transformation.
            </p>
          </div>
        </div>
      </div>
